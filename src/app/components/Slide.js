    ...
    return (
        <div className="relative border-none outline-none">
            <div className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
                <h3 className="text-blue-400 text-accent text-[24px] lg:text-[28px]">{title}</h3>
            ...
            <Image className="w-full h-[250px] md:h-[400px] lg:h-[500px] rounded-xl object-cover object-right md:object-left-bottom"
